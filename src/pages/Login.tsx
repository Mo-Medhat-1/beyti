      ...
      <div className="min-h-[80vh] flex items-center justify-center section-padding">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <img src={logo} alt="Beyti" className="h-20 mx-auto mb-4" />
            <h1 className="text-2xl font-bold text-primary">
              {isLogin ? "مرحباً بعودتك!" : "انضم لعائلة بيتي"}
            </h1>
            <p className="text-muted-foreground mt-2">
              {isLogin
                ? "سجل دخولك لتكمل طلبك"
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["عميل", "طباخ"].map((role) => (
                      <label
                        key={role}
                        className="flex items-center justify-center p-3 rounded-xl border border-border cursor-pointer hover:border-secondary transition-colors [&:has(input:checked)]:border-secondary [&:has(input:checked)]:bg-secondary/10"
                      >
                        <input
                          type="radio"
                          name="role"
